...
const ContactPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "You can reach us via email at info@fin-unique.com. or call us at 01414511098 during business hours.",
    },
  ];
            ...
            <div className="text-white lg:pr-8">
              ...
              <div className="space-y-4 sm:mt-12 lg:mt-56  text-gray-500">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a href="mailto:info@fin-unique.com." className="hover:underline text-sm sm:text-base">
                    info@fin-unique.com.
                  </a>
                </div>
                <div className="flex items-center gap-4">
