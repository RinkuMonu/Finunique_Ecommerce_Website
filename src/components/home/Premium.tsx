  ...
  return (
    <div className="bg-gray-50 py-6 px-4">
      <div className="flex justify-between items-center mb-3  mx-16 mt-10">
        <div>
          <h2 className="text-2xl font-bold">Premium Smart Watches- Get Instant Bank Discount
          </h2>
          {/* <p className="text-sm text-gray-600">Starting at Rs. 9999*</p> */}
        </div>
        <a href="/category/Smart%20Watches" className="text-sm text-indigo-600 font-semibold hover:underline">View All →</a>
      </div>
        ...
        {tablets.map((item, index) => (
          <SwiperSlide key={index}>
           <div className="border relative rounded-xl p-4 bg-white shadow-sm hover:shadow-md transition">
              ...
              <div className="text-sm text-gray-500 line-through mt-1">{item.mrp}</div>
            </div>
          </SwiperSlide>
        ))}
      </Swiper>
