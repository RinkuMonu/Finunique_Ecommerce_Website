        ...
        const fetchProducts = async () => {
            try {
                const res = await fetch(
                    `${baseUrl}/product/getproducts?referenceWebsite=${referenceWebsite}&category=${encodeURIComponent("Bluetooth & Smart Speakers")}`
                );
    ...
    return (
        <div className="bg-gray-50 py-6 px-4">
            <div className="flex justify-between items-center mb-3  mx-20">
                ...
                <Link to={`/category/${slugify("Bluetooth & Smart Speakers")}`} className="text-sm text-indigo-600 font-semibold hover:underline">View All →</Link>
            </div>
